...
namespace GLPainter {
    ...
    public static partial class OpenGL {
        ...
        public delegate void PFNGLSHADERSOURCEPROC(GLuint shader, GLsizei count, string[] @string, GLint[] length);
        ...
        public static void glShaderSource_(GLuint shader, string @string) {
            glShaderSource(shader, 1, new[] { @string }, new GLint[] { @string.Length });
        }
    ...
    public static partial class OpenGL {
        ...
        public static PFNGLGENBUFFERSPROC glGenBuffers { get; } = Marshal.GetDelegateForFunctionPointer<PFNGLGENBUFFERSPROC>(Marshal.ReadIntPtr(wglGetProcAddress("glGenBuffers")));
    }
    ...
    public static class GLFW {
        ...
        public delegate void glfwWindowSizeCallbackDelegate(IntPtr /* GLFWwindow* */ window, int width, int height);

        [DllImport("glfw3.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static void glfwSetWindowSizeCallback(IntPtr /* GLFWwindow* */ window, glfwWindowSizeCallbackDelegate callback);
    }
