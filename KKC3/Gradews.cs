...
namespace KKC3 {
    public class Gradews {
        ...
        public static void Test() {
            var r = "スガ シカオ 、 スキマ スイッチ 、 斉藤 和義 、 これ ら の 人 に 共通 する こと は 何 か ご 存じ です か ？ 実 は 、 佐賀 の 職人 が 手作り し て いる アコースティック ギター を 愛用 し て いる アーティスト たち な ん です 。";
            var t = "スガ シカオ 、 スキマ スイッチ 、 斉藤 和義 、 これ ら の 人 に 共通 する こと は 何 か ご 存じ です か ？ 実 は 、 佐賀 の 職人 が 手作り し て いる アコースティック ギター を 愛用 し て いる アーティスト たち な ん です 。";
            var g = new Gradews();
            g.Comparer(r, t);
            System.Console.WriteLine($"F={g.Fmeas}");
        }
