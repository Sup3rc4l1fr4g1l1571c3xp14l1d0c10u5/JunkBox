...
var CanvasTextEditor = function (doc, options) {
    ...
    document.addEventListener('keyup', this.removeKeyModifier.bind(this), true);
 ...
 * @param {Event} e
 */
CanvasTextEditor.prototype.removeKeyModifier = function (e) {
    if (e.keyCode === 16) {
 ...
 * Get selected text
 */
CanvasTextEditor.prototype.getSelectedText = function () {
    // Assume that selection is empty
    var selectedText = '';
...
CanvasTextEditor.prototype._createWrapper = function () {
    ...
    this.wrapper.style.border = this.options.border + 'px solid ' + this.options.backgroundColor;
...
CanvasTextEditor.prototype._createInput = function () {
    ...
    //this.inputEl.style.height = '50px';
    //this.inputEl.style.width = '100px';
