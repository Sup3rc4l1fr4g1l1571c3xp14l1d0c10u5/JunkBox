...
Opal.modules["opal/jquery/element"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$to_n', '$include', '$each', '$alias_native', '$attr_reader', '$call', '$nil?', '$[]', '$[]=', '$raise', '$is_a?', '$has_key?', '$delete', '$from_object', '$gsub', '$upcase', '$compact', '$map', '$respond_to?', '$<<', '$Native', '$new']);
  self.$require("native");
...
if (e == null) e = nil;
    ...
    return (Opal.defn(self, '$position', TMP_46 = function $$position() {
      var self = this;

      return self.$Native(self.position());
    }, TMP_46.$$arity = 0), nil) && 'position';
