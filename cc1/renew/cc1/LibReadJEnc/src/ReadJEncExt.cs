...
namespace LibReadJEnc {
    public partial class ReadJEnc {
        ...
        public static StreamReader CreateStreamReaderFromFile(
            string path, 
            ...
            if (autoDetectEncoding) {
                // 自動認識モード
                enc = DetectEncodingFromFile(path);
                if (enc == null) {
        ...
        /// </summary>
        internal class DecoderScalarValueFallback : System.Text.DecoderFallback {
            // 置き換えられる代替文字列の最大文字数
