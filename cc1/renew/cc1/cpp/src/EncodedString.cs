...
namespace CSCPP {
    ...
    public class EncodedString {
        ...
        /// <summary>
        /// １文字を表現するのに必要な最小のバイトサイズ
        /// </summary>
        private int wordSize {
            get;
        }

        public EncodedString(byte[] bytes, System.Text.Encoding encoding = null) {
        ...
        public EncodedString(string str, System.Text.Encoding encoding = null) {
            encoding = encoding ?? System.Text.Encoding.Default;
            this.Encoding = encoding;
            this.wordSize = (encoding.CodePage == System.Text.Encoding.Unicode.CodePage || encoding.CodePage == System.Text.Encoding.BigEndianUnicode.CodePage) ? 2
                          : (encoding.CodePage == System.Text.Encoding.UTF32.CodePage) ? 4
        ...
        public static EncodedString FromCStyle(string str, Action<bool, string> errorCallback, System.Text.Encoding encoding = null) {
            encoding = encoding ?? System.Text.Encoding.Default;
            var wordSize = (encoding.CodePage == System.Text.Encoding.Unicode.CodePage || encoding.CodePage == System.Text.Encoding.BigEndianUnicode.CodePage) ? 2
                          : (encoding.CodePage == System.Text.Encoding.UTF32.CodePage) ? 4
                          : 1;
            return new EncodedString(encoding, wordSize, ParseCStyle(encoding, wordSize, str, errorCallback));
        }

        private EncodedString(System.Text.Encoding encoding, int wordSize, byte[] datas) {
            this.Encoding = encoding;
            this.wordSize = wordSize;
            this.data = datas;
        }
        public EncodedString encode(System.Text.Encoding newEncoding) {
            return new EncodedString(newEncoding, wordSize, System.Text.Encoding.Convert(this.Encoding, newEncoding, this.data));
        }
        ...
        public override bool Equals(object obj) {
            return (obj is EncodedString) ? Equals(this, (obj as EncodedString)) : (obj is String) ? Equals(this, (obj as String)) : false;
        }

        public static bool Equals(EncodedString self, EncodedString other) {
        ...
        public static bool Equals(EncodedString self, String other) {
            if ((object)other == null) {
                return false;
            }
        ...
        public static bool operator ==(EncodedString self, EncodedString other) {
            return Equals(self, other);
        }
        public static bool operator !=(EncodedString self, EncodedString other) {
            return !Equals(self, other);
        }
        public static bool operator ==(EncodedString self, String other) {
            return Equals(self, other);
        }
        public static bool operator !=(EncodedString self, String other) {
            return !Equals(self, other);
